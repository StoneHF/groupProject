...
<form method="post" action="game_voting_form.php" id="competitionForm">
...
<form method="post" action="process_game_voting_form.php">
  <div class="gallery-container">
    <?php
      ...
      $sql = "SELECT * FROM tbl_comp_game_images WHERE fldCompImageID NOT IN (
        SELECT fldCompImageID FROM tbl_comp_results WHERE fldMemberID = '{$_SESSION['fldMemberID']}'
      )
      {$year_filter}
